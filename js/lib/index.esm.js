...
import { PublicKey, Connection, clusterApiUrl, Keypair, TransactionInstruction, SystemProgram, SYSVAR_RENT_PUBKEY, Transaction, Ed25519Program } from '@solana/web3.js';
...
const extractPublicKeyUsed = tx => {
  ...
  const data = bs58.decode(instructionData).toJSON().data;
...
export { RandomnessFullfilled, RandomnessRequested, createOrGetRandomnessRequest, verifyRandomnessOffchain };
